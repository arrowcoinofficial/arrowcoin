...
const string strMessageMagic = "Arrowcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Arrowcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        if (!fAllowNew)
            ...
            const char* pszTimestamp = "12 Percent of Current Crypto Market Cap Was Created During 2018";
            CTransaction txNew;
            txNew.nTime = 1548897850;
            txNew.vin.resize(1);
            txNew.vout.resize(1);
            ...
            block.nVersion = 1;
            block.nTime    = 1548897850;
            block.nBits    = bnProofOfWorkLimit.GetCompact();
            block.nNonce   = 1028189;
    		if(fTestNet)
            {
                block.nNonce   = 599783;
            }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x4d00019eda53b7d7413a1c93a58154a6874aad9c243d8fc4bf78145896a802cb"));
        block.print();
